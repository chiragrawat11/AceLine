    ...
    [334], {
        ...
        757(e, t, n) {
            ...
            t.default = elementorModules.frontend.handlers.Base.extend({
                ...
                onInit() {
                    if (this.menuHeightController = new elementorProFrontend.utils.DropdownMenuHeightController(this.dropdownMenuHeightControllerConfig()), elementorModules.frontend.handlers.Base.prototype.onInit.apply(this, arguments), this.elements.$menu.length && (this.elements.$menu.smartmenus({
                            subIndicators: !1,
